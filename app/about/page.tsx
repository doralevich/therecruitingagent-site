...
export const metadata: Metadata = pageMeta({
  ...
  description:
    "The Recruiting Agent is built by Apollo Claw, in-house on Long Island. Who builds it, why it exists, and how engagements are handled.",
  path: "/about",
  keywords: [
    "Apollo Claw",
    "David Oralevich",
        ...
        <section className="grid-light-section py-20">
          <div className="max-w-3xl mx-auto px-6">
            ...
            <div className="text-ink leading-relaxed space-y-4">
              ...
              <p>
                What he saw was a gap. Hiring teams were drowning in scheduling and paperwork while AI
                sat untapped. The technology existed to take the first pass at
                everything that was not a decision about a person. Nobody had built it
              ...
              <p>
                ...
                each one purpose-built for a role. The Recruiting Agent is built on the same
                foundation.
              </p>
              <p>
        ...
        <section className="bg-white py-20">
          <div className="max-w-3xl mx-auto px-6">
            ...
            <div className="text-lg text-ink leading-relaxed space-y-4">
              <p>
                The Recruiting Agent is one of a family of role-specific agents from Apollo
              ...
              <p>
                ...
                useful to nobody in particular. An agent that understands why candidates
                go quiet, what a resume hides, and which decisions must never be
                automated is useful to you.
              </p>
            </div>
          </div>
        </section>

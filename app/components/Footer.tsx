        ...
        <div className="grid gap-10 md:grid-cols-4">
          <div>
            <Link href="/" aria-label={`${SITE_NAME} home`}>
              ...
              <img
                src="/images/the-recruiting-agent-wordmark.png"
                alt={SITE_NAME}
                className="w-44 h-auto"
              />
            </Link>
            <p className="text-sm text-gray-500 mt-4 leading-relaxed">
              A private AI agent built around what a great hire looks like in your business, your
              fairness rules, and the decisions only a person may make.
            </p>
          </div>

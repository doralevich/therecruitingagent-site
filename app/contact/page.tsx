...
export const metadata: Metadata = pageMeta({
  title: "Contact",
  description:
    "Talk to Apollo Claw about The Recruiting Agent. Book a 30-minute consultation, or reach us by email or phone from Roslyn Heights, New York.",
  path: "/contact",
  keywords: ["contact Apollo Claw", "recruiting AI consultation", "book AI demo recruiting"],
});

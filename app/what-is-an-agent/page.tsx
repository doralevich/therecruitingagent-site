...
const COMPARISON = [
  ...
  },
  {
    ...
    agent: "It keeps a working memory of your roles, your candidates, and what you are actually hiring for.",
  },
  {
    chatbot: "It can only tell you what to do.",
    agent: "It connects to your ATS and your calendars and produces the summary or the scheduling itself.",
  },
  {
    chatbot: "It is the same product for everyone.",
    agent: "It is configured around your requirements, your fairness rules, and the decisions it may never make.",
  },
  {
      ...
      <main>
        ...
        <section className="bg-white py-20">
          <div className="max-w-3xl mx-auto px-6">
            ...
            <div className="text-lg text-ink leading-relaxed space-y-4">
              ...
              <p>
                That is the whole distinction, and it is why an agent can be measured in roles filled
                and candidates answered instead of in prompts.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white py-20">
          <div className="max-w-3xl mx-auto px-6">
            ...
            <div className="text-lg text-ink leading-relaxed space-y-4">
              <p>
                Hiring runs on other people's information: their history, their salary, their reasons for leaving, and the fact that they applied at all. That is not material to hand to a shared consumer product.
              </p>
              <p>
        ...
        <ClosingCta
          ...
          body="Build your agent online in about fifteen minutes, or book a consultation and we will walk through exactly what it would do for your hiring."
        />
      </main>
      <Footer />
    </>
